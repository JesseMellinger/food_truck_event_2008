...
class EventTest < Minitest::Test
  ...
  def test_it_can_have_food_trucks_added
    event = Event.new("South Pearl Street Farmers Market")
  ...
  def test_get_food_trucks_that_sell
    event = Event.new("South Pearl Street Farmers Market")
  ...
  def test_get_overstocked_items
    event = Event.new("South Pearl Street Farmers Market")
